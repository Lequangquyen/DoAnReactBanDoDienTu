...
const VerticalCard = ({loading,data=[]}) => {
  ...
  return (
    <div className='grid grid-cols-[repeat(auto-fit,minmax(280px,289px))] justify-center md:justify-between  md:gap-4 overflow-x-scroll scrollbar-none transition-all'>
           {

                loading ? (
                    loadingList.map((product,index)=>{
                        return(
                            <div className='w-full min-w-[280px]  md:min-w-[320px] max-w-[280px] md:max-w-[300px]  bg-white rounded-sm shadow '>
